class Mychildreen {
  ...
  Mychildreen({this.academicYear, this.lastName, this.parent, this.activePayment, this.nameAr, this.notif, this.lastNameAr, this.schoolCode,
  this.Class, this.group, this.name, this.birthdateStudent, this.classId, this.studentId, this.admissionDate, this.companyId, this.parentId, this.gender, this.ref, this.image});

  Mychildreen.fromJson(Map<String, dynamic> json) {
